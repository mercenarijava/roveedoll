...
public class Marce extends FrameLayout {
    ...
    public Marce(Context context) {
        super(context);
        init(context, null);
    }

    public Marce(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public Marce(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        TypedArray attributeArray = context.obtainStyledAttributes(
                attrs, R.styleable.DiscreteSlider);
